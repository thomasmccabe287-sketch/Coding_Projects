...
void sort_pairs(void)
{
    ...
    {
        int strongest = preferences[pair[i].winner][pair[i].loser] - preferences[pair[i].loser][pair[i].winner];
        int current_strongest;
        int strongest_index = i;
        for (int j = 0; j < pair_count, j++)
        {
            current_strongest = preferences[pair[j].winner][pair[j].loser] - preferences[pair[j].loser][pair[j].winner];
